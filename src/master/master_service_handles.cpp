...
//  *
//  */
// auto client_conns_mut = std::mutex{};
// auto client_conns = std::set<std::shared_ptr<common::connection>>{};
...
//  *
//  */
// auto storage_conns_mut = std::mutex{};
// auto storage_conns = std::map<uint32_t, std::shared_ptr<common::connection>>{};
...
//   auto lock = std::unique_lock{storage_conns_mut};
//   storage_conns.erase(conn->get_data<uint32_t>(s_conn_data::storage_id).value());
//   storage_conns_vec = {};
...
// auto get_storages() -> std::vector<std::shared_ptr<common::connection>> {
//   auto lock = std::unique_lock{storage_conns_mut};
//   return storage_conns_vec;
// }

// auto storage_exists(uint32_t id) -> bool {
//   auto lock = std::unique_lock{storage_conns_mut};
...
// auto group_storages(uint32_t group) -> std::vector<std::shared_ptr<common::connection>> {
